...
function ArticleRelated({title, authorData, date, slug}) {
  let Date = date;
  ...
  return (
    <article className="related-post__card">
      ...
      {/* <a href={`/post/:${slug}`} className="related-post__title">{title}</a> */}
      <NavLink className="related-post__title"  to={`/post/:${slug}`} >
              {title}
      </NavLink>
      <div className="related-post__info">
        {/* <a className="related-post__author" href="/">John Smith</a> */}
        <a className="related-post__author" href="/">{authorData}</a>
